...
export enum I18nKey {
  ...
  SETTINGS$DANGER_ZONE = "SETTINGS$DANGER_ZONE",
  SETTINGS$DELETE_ACCOUNT = "SETTINGS$DELETE_ACCOUNT",
  SETTINGS$DELETE_ACCOUNT_DESCRIPTION = "SETTINGS$DELETE_ACCOUNT_DESCRIPTION",
  SETTINGS$DELETE_ACCOUNT_CONFIRMATION = "SETTINGS$DELETE_ACCOUNT_CONFIRMATION",
}
